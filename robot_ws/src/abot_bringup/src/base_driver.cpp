...
void BaseDriver::cmd_vel_callback(const geometry_msgs::Twist& vel_cmd)
{
    ...
    // Data_holder::get()->velocity.v_liner_x = vel_cmd.linear.x*250;
    // Data_holder::get()->velocity.v_liner_y = vel_cmd.linear.y*250;
    // Data_holder::get()->velocity.v_angular_z = vel_cmd.angular.z*150;

    Data_holder::get()->velocity.v_liner_x = vel_cmd.linear.x*300;
    Data_holder::get()->velocity.v_liner_y = vel_cmd.linear.y*300;
    Data_holder::get()->velocity.v_angular_z = vel_cmd.angular.z*200;
